...
当前 NebulaDash 包版本为 `2.8.0-nebula.4`，上游代码基线仍来自 Zashboard
...
- 当前发布版本已推进到 `2.8.0-nebula.4`；仍保持 Zashboard `2.8.0` 基线，未冒充上游 3.x。
- 发布前检查已固化为 `pnpm release:check`，用于校验 Nebula 版本格式和 tag/package 一致性。
- `v2.8.0-nebula.4` Release 已完成，`latest/download/dist.zip` 已确认跳转到该版本。
