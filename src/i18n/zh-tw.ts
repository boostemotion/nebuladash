...
const zhTW: LANG_MESSAGE = {
  ...
  providerLoadTimeoutTip: '代理商介面逾時，已保留可用快取',
  providerLoadErrorTip: '代理商載入失敗，已保留可用快取',
  upgradeUI: '更新面板',
  checkUIUpdate: '檢查新版本',
  uiUpdateStatus: '版本狀態',
  uiUpdateAvailable: '發現新的 NebulaDash 版本：{version}',
  uiUpdateCurrent: 'NebulaDash 已經是最新版本',
  uiUpdateAhead: '目前版本高於 latest release：{current} > {version}',
  uiUpdateUnknown: '無法檢查最新的 NebulaDash Release',
  upgradeUIDisabledTip: '後端 UI 下載地址未指向 NebulaDash，已禁止更新面板。請配置為：',
  routerUpdater: 'NebulaDash 更新器',
  routerUpdaterEndpoint: '更新器地址',
  routerUpdaterToken: '更新器密鑰',
  routerUpdaterStatus: '更新器狀態',
  routerUpdaterCheck: '檢查更新器',
  routerUpdaterUpdate: '更新 NebulaDash',
  routerUpdaterRollback: '回滾 NebulaDash',
  ...
  nodeClusterVariants: '節點聚類詞表',
  nodeClusterVariantsPlaceholder:
    '示例：手動|manual, 自動|auto, 故轉|fallback, 負載均衡|loadbalance',
  allowLan: '允許區域網路',
  ...
  search: '搜尋',
  searchMultiple: '多個關鍵詞可用空格、逗號或 | 分隔',
  importing: '正在匯入',
  hideConnection: '隱藏連接',
  showConnection: '顯示連接',
  ...
  selectBackend: '選擇後端',
  requiredBackendFields: '請填寫協議、主機和端口',
