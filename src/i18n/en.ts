const en = {
  ...
  nodeClusterVariants: 'Node cluster variants',
  nodeClusterVariantsPlaceholder:
    'Example: 手动|manual, 自动|auto, 故转|fallback, 负载均衡|loadbalance',
  allowLan: 'Allow LAN',
  ...
  search: 'Search',
  searchMultiple: 'Separate keywords with space/comma/|',
  importing: 'Importing...',
  ...
  requiredBackendFields: 'Please fill in protocol, host, and port.',
