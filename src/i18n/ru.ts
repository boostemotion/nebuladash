...
const ru: LANG_MESSAGE = {
  ...
  strategyGroup: 'Группы стратегий',
  nodeGroup: 'Группы узлов',
  ...
  routerUpdaterEndpoint: 'Endpoint обновления',
  routerUpdaterToken: 'Токен обновления',
  routerUpdaterStatus: 'Статус обновления',
  routerUpdaterCheck: 'Проверить обновление',
  routerUpdaterUpdate: 'Обновить NebulaDash',
  routerUpdaterRollback: 'Откатить NebulaDash',
  ...
  ruleShortcut: 'Быстрый доступ к правилам',
  goToRules: 'Перейти к правилам',
  fullChain: 'Полная цепочка',
  ...
  nodeClusterVariants: 'Варианты кластеризации узлов',
  nodeClusterVariantsPlaceholder:
    'Пример: ручной|manual, авто|auto, отказ|fallback, баланс|loadbalance',
  ...
  search: 'Поиск',
  searchMultiple: 'Ключевые слова разделяйте пробелом, запятой или |',
  ...
  requiredBackendFields: 'Заполните протокол, хост и порт.',
