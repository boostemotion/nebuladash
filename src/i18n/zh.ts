...
const zh: LANG_MESSAGE = {
  ...
  checkUIUpdate: '检查新版本',
  uiUpdateStatus: '版本状态',
  uiUpdateAvailable: '发现新的 NebulaDash 版本：{version}',
  uiUpdateCurrent: 'NebulaDash 已经是最新版本',
  uiUpdateAhead: '当前版本高于 latest release：{current} > {version}',
  uiUpdateUnknown: '无法检查最新的 NebulaDash Release',
  ...
  routerUpdaterSameVersionConfirm:
    '最新 NebulaDash Release（{version}）与当前版本相同。是否继续覆盖安装？',
  routerUpdaterDowngradeConfirm:
    '最新 NebulaDash Release（{remote}）低于当前版本（{current}）。继续会回退到旧版本，是否继续？',
  routerUpdaterUnknownVersionConfirm: '无法确认最新 NebulaDash Release 版本。是否仍然继续更新？',
  reloadConfigs: '重载配置',
  updateConfigs: '更新配置',
  ...
  nodeClusterVariants: '节点聚类词表',
  nodeClusterVariantsPlaceholder:
    '示例：手动|manual, 自动|auto, 故转|fallback, 负载均衡|loadbalance',
  allowLan: '允许局域网',
  ...
  search: '搜索',
  searchMultiple: '多个关键词可用空格、逗号或 | 分隔',
  importing: '正在导入',
  hideConnection: '隐藏连接',
  showConnection: '显示连接',
  ...
  selectBackend: '选择后端',
  requiredBackendFields: '请填写协议、主机和端口',
